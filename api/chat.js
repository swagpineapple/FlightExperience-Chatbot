...
Address: 30 Raffles Ave, #02-06 Singapore Flyer. Open daily 10am to 10pm.
...
YOUNG AVIATORS: SGD 140. Kids under 15. Single circuit ~20 min. Certificate, wings pin, photo.

FLYING CLUB: Structured Boeing 737 progression programme. Earn solo operator status.
...
PROMOTIONS:
Student Special: SGD 50 off Skyline with code HOLIDAY2026 (student ID required, not valid Saturdays).
VR: Buy 2 Get 1 FREE for June 2026.
Singapore Flyer visitors: 10% off 30-min and 60-min packages.

FAQs: No experience needed. Ages 5+. Over 180,000 people have flown. CASA approved. Boeing licensed.`;
  ...
  const reply = data.content?.map(b => b.text || '').join('') || 'Sorry, something went wrong. Please ca
